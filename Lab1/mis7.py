...
#выражение оценивает "расстояние" между цветом c и цветом центрального пикселя center_pixel_color. Чем меньше это расстояние, тем ближе цвет c к цвету центрального пикселя.
